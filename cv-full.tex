...
% This is the slightly more thorough version
...
\begin{itemize}
	...
	\item
	\headerrow
		{\textbf{Piksel (formerly KIT digital)}}
		{\textbf{London, UK}}
	\headerrow
		{\emph{Senior Technical Architect}}
		{\emph{03/2013 -- 10/2013}}
	\headerrow
		{\emph{Technical Architect}}
		{\emph{01/2012 -- 02/2013}}
	\headerrow
		{\textbf{ioko}}
		{\textbf{London, UK}}	
	\headerrow
	...
	\subsection*{\emph{Projects}}
		\begin{itemize}
			\item 
			\headerrow
				{\textbf{Celcom, Axiata Group Berhad (www.escnow.com - Escape)}}
				{\textbf{Kuala Lumpur, Malaysia}}
			\\
			\headerrow
				{\emph{Senior Technical Architect}}
				{\emph{2012 - 2013}}
		        A newly launched Video on Demand site, working with the region's largest cellular telephony company to deliver premium content to existing subscribers. Current role as infrastructure architect, specialising in the development of automated deployment systems and platform content delivery strategy.
			\item 
			\headerrow
...
\begin{itemize}
	...
	\headerrow
		...
		\begin{itemize*}
			\item Co-ordinated and implemented datacentre migration 
     		\item Improved site performance across the board through implementation of caching software
       		\item Provide technical guidance to mySociety developers on scaling and performance testing
       		\item Authored security and compliance policies
		\end{itemize*}
	\item
	\headerrow
		{\textbf{no2id}}
	...
	\headerrow
		...
		\begin{itemize*}
			\item Improved monthly mailshot delivery reliability and completion speed
			\item On-going system administration and support
		\end{itemize*}
	\item
	\headerrow
	...
	\headerrow
		...
		\begin{itemize*}
			\item Development of system architecture
			\item Facilitated a platform migration to allow redundancy and resiliency for all ORG Internet services
			\item On-going system administration and support
		\end{itemize*}
	\item
	\headerrow
