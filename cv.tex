...
\begin{itemize}
    ...
    \item
        ...
        \headerrow
            ...
            \begin{itemize*}
                \item Initially split role between Functional and Vertical, later became SME in Media and Entertainment for APAC
                \item Creating and driving both internal and external go to market strategies and service offerings
                \item Regularly travel globally for public speaking and customer engagement, helping to build Amazon's profile, while driving adoption and excellence
                \item Multi-level engagement, from driving CxO buy-in to network level optimisation
            \end{itemize*}
